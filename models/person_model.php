...
class Person_model extends Base_model
{
    ...
    public function add_person($pid = 0, $assetid = '',$name = '', $sex = '', $post = '', $depart = '', $phone = '', $mobile = '', $email = '', $import = 1)
    {
    ...
    public function update_person($id = 0, $pid = 0, $assetid = '',$name = '', $sex = 1, $post = '', $depart = '', $phone = '', $mobile = '', $email = '', $import = 0)
    {
        $newPerson = array( 'pid'    => $pid,
                            'assetid'=> $assetid,
                            'name'   => $name,
